...
//
// The returned value is an id understood by internal/tokenizer; an id whose asset
// is missing is handled there by falling back to a calibrated cl100k count rather
