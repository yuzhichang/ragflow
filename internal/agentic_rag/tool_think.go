...
func (t *ThinkTool) InvokableRun(ctx context.Context, argumentsInJSON string, _ ...einotool.Option) (string, error) {
	return guardedToolRun(ctx, thinkToolName, t.invokableRun, argumentsInJSON)
}

func (t *ThinkTool) invokableRun(_ context.Context, argumentsInJSON string) (string, error) {
	var args thinkArgs
