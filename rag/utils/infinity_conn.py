...
class InfinityConnection(DocStoreConnection):
    ...
    def createIdx(self, indexName: str, knowledgebaseId: str, vectorSize: int):
        ...
        inf_table.create_index(
            "text_idx6",
            IndexInfo("docnm_kwd", IndexType.FullText, {"ANALYZER": "standard"}),
            ConflictType.Ignore,
        )
        inf_table.create_index(
            "text_idx7",
            IndexInfo("name_kwd", IndexType.FullText, {"ANALYZER": "standard"}),
            ConflictType.Ignore,
        )
        inf_table.create_index(
            "text_idx8",
            IndexInfo("knowledge_graph_kwd", IndexType.FullText, {"ANALYZER": "standard"}),
            ConflictType.Ignore,
        )
        inf_table.create_index(
            "text_idx9",
            IndexInfo("entities_kwd", IndexType.FullText, {"ANALYZER": "standard"}),
            ConflictType.Ignore,
        )
