...
class Dealer:
    ...
    def search(self, req, idxnm: str, emb_mdl, highlight = False):
        kb_ids = req['kb_ids']
        ...
        if not qst:
            if req.get("sort"):
                orderBy.asc("page_num_list").asc("top_list").desc("create_timestamp_flt")
            else:
    ...
    def retrieval(self, question, embd_mdl, tenant_id, kb_ids, page, page_size, similarity_threshold=0.2,
        ...
        for i in idx:
            ...
            d = {
                ...
                "positions": json.loads(chunk.get("position_list", "[]"))
            }
            if highlight:
    ...
    def chunk_list(self, doc_id: str, tenant_id: str, kb_ids: list[str], max_count=1024, fields=["docnm_kwd", "content_with_weight", "image_id"]):
